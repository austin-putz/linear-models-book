...
*   Construct and solve the normal equations for multiple regression in matrix form.
*   Interpret partial regression coefficients and distinguish them from marginal effects.
*   Partition sums of squares into sequential (Type I) and partial (Type III) components.
*   Identify collinearity and quantify its impact using Variance Inflation Factors (VIF).
*   Compare and select models using criteria such as AIC, BIC, and Mallows' $C_p$.
